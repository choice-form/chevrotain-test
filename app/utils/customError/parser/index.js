...
const parseMismatch = parseStartingWithRule('mis_match');
const parseMismatchOverride = parseStartingWithRule('mis_match_override');
const parseRedundant = parseStartingWithRule('redundant_input');
const parseNoViable = parseStartingWithRule('no_viable_alternative');
const parseEarlyExit = parseStartingWithRule('early_exit');

export function customParser() {
  console.log('parseMismatch');
  console.log(parseMismatch('A C'));
  console.log('parseMismatchOverride');
  console.log(parseMismatchOverride('A C'));
  console.log('parseRedundant');
  console.log(parseRedundant('A B C'));
  console.log('parseNoViable');
  console.log(parseNoViable('C'));
  console.log('parseEarlyExit');
  console.log(parseEarlyExit('A'));
}
